  ...
  <body>
    ...
    <section class="section12">
      <section id="Home" class="about">
        ...
        <div class="row">
          ...
          <p class="about-p">
            ...
            <strong> XII TKJ 1</strong>. Tujuan kami membuat web ini adalah
            untuk mengabadikan kenangan yang terjadi selama masa sekolah. Terima
      ...
      <section class="products">
        <div class="product">
          <img
            src="../gambar/istockphoto-1324041343-612x612.jpg"
            alt="Produk 2"
            class="img2"
          />
          <h2></h2>
